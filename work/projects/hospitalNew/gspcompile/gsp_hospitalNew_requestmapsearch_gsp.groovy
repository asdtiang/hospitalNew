...
class gsp_hospitalNew_requestmapsearch_gsp extends GroovyPage {
...
printHtmlPart(15)
createTagBody(4, {->
codecOut.print(fieldValue(bean: requestmap, field: "url"))
})
invokeTag('link','g',57,['action':("edit"),'id':(requestmap.id)],4)
printHtmlPart(16)
codecOut.print(fieldValue(bean: requestmap, field: "configAttribute"))
printHtmlPart(17)
i++
}
}
...
public static final long LAST_MODIFIED = 1340368264454L
