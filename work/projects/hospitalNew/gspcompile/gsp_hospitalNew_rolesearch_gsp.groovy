...
class gsp_hospitalNew_rolesearch_gsp extends GroovyPage {
...
printHtmlPart(13)
createTagBody(4, {->
codecOut.print(fieldValue(bean: role, field: "authority"))
})
...
printHtmlPart(18)
codecOut.print(createLink(action: 'ajaxRoleSearch'))
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1340368264694L
