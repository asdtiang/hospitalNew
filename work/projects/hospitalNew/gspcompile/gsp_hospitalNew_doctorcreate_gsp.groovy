...
class gsp_hospitalNew_doctorcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(doctorInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(doctorInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1344777526930L
