...
class gsp_hospitalNew_bloodUseredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bloodUser/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'bloodUser.label', default: 'BloodUser'))],-1)
printHtmlPart(2)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',27,['bean':(bloodUserInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',29,['bean':(bloodUserInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',31,['name':("id"),'value':(bloodUserInstance?.id)],-1)
printHtmlPart(21)
invokeTag('hiddenField','g',32,['name':("version"),'value':(bloodUserInstance?.version)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1345132618042L
