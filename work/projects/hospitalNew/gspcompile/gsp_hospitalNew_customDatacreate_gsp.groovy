...
class gsp_hospitalNew_customDatacreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/customData/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',28,['bean':(customDataInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',30,['bean':(customDataInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1364473952031L
