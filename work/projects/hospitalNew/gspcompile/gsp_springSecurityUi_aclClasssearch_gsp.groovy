...
printHtmlPart(13)
createTagBody(4, {->
codecOut.print(fieldValue(bean: aclClass, field: "className"))
})
...
printHtmlPart(18)
codecOut.print(createLink(action: 'ajaxAclClassSearch'))
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1332861665171L
