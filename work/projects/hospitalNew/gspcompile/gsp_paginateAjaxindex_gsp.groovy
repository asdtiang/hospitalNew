...
class gsp_paginateAjaxindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/paginate-ajax-0.1/grails-app/views/index.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',12,['controller':("testAjax"),'class':("list"),'action':("addTestData")],2)
printHtmlPart(5)
})
