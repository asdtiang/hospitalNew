...
class gsp_hospitalNew_shiQiaoSearchmany_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/shiQiaoSearch/many.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',42,['controller':("shiQiaoSearch"),'action':("result"),'params':([date:patient.date,sampleId:patient.sampleId])],3)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1352121372526L
