...
@GrailsPlugin(name = 'ckeditor', version = '3.6.2.1')
class gsp_ckeditorofm_gsp extends GroovyPage {
    public String getGroovyPageFileName() { "/WEB-INF/plugins/ckeditor-3.6.2.1/grails-app/views/ofm.gsp" }
    ...
    public static final long LAST_MODIFIED = 1308310750000L
