...
printHtmlPart(22)
createTagBody(4, {->
codecOut.print(oid.id)
})
invokeTag('link','g',86,['action':("edit"),'id':(oid.id)],4)
printHtmlPart(23)
createTagBody(4, {->
codecOut.print(fieldValue(bean: oid.aclClass, field: "className"))
})
invokeTag('link','g',87,['action':("edit"),'controller':("aclClass"),'id':(oid.aclClass.id)],4)
printHtmlPart(23)
codecOut.print(fieldValue(bean: oid, field: "objectId"))
printHtmlPart(23)
...
printHtmlPart(25)
createTagBody(5, {->
codecOut.print(fieldValue(bean: oid.owner, field: "sid"))
})
...
public static final long LAST_MODIFIED = 1332861665453L
