...
class gsp_hospitalNew_feedBackedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(feedBackInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(feedBackInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1352121372705L
