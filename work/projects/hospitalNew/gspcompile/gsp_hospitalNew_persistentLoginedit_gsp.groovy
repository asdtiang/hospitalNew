...
class gsp_hospitalNew_persistentLoginedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/persistentLogin/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
codecOut.print(message(code: 'persistentLogin.series.label', default: 'Series'))
printHtmlPart(8)
codecOut.print(persistentLogin.id)
printHtmlPart(9)
codecOut.print(message(code: 'persistentLogin.username.label', default: 'Username'))
printHtmlPart(8)
codecOut.print(persistentLogin.username)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1340368264612L
