...
printHtmlPart(7)
codecOut.print(hasErrors(bean: aclObjectIdentity, field: 'aclClass', 'errors'))
printHtmlPart(8)
...
printHtmlPart(9)
codecOut.print(fieldError(bean: aclObjectIdentity, field: 'aclClass'))
printHtmlPart(10)
...
printHtmlPart(7)
codecOut.print(hasErrors(bean: aclObjectIdentity, field: 'owner', 'errors'))
printHtmlPart(8)
...
printHtmlPart(9)
codecOut.print(fieldError(bean: aclObjectIdentity, field: 'owner'))
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1332861665343L
