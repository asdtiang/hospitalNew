...
class gsp_hospitalNew_layoutsspringSecurityUI_gsp extends GroovyPage {
...
printHtmlPart(5)
codecOut.print(fam.icon(name: 'lock'))
printHtmlPart(6)
codecOut.print(fam.icon(name: 'group'))
printHtmlPart(7)
codecOut.print(fam.icon(name: 'user'))
printHtmlPart(8)
codecOut.print(fam.icon(name: 'exclamation'))
printHtmlPart(9)
codecOut.print(fam.icon(name: 'information'))
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1340368264626L
