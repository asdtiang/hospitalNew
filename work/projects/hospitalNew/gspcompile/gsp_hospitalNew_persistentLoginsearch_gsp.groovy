...
class gsp_hospitalNew_persistentLoginsearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/persistentLogin/search.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(15)
createTagBody(4, {->
codecOut.print(fieldValue(bean: persistentLogin, field: "id"))
})
invokeTag('link','g',63,['action':("edit"),'id':(persistentLogin.id)],4)
printHtmlPart(16)
createTagBody(4, {->
codecOut.print(fieldValue(bean: persistentLogin, field: "username"))
})
invokeTag('link','g',64,['controller':("user"),'action':("edit"),'params':([username: persistentLogin.username])],4)
printHtmlPart(16)
codecOut.print(fieldValue(bean: persistentLogin, field: "token"))
printHtmlPart(16)
...
printHtmlPart(21)
codecOut.print(createLink(action: 'ajaxPersistentLoginSearch'))
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1340368264611L
