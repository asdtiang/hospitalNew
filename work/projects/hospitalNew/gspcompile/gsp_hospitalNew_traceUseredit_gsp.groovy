...
class gsp_hospitalNew_traceUseredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/traceUser/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(traceUserInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',29,['bean':(traceUserInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',31,['name':("id"),'value':(traceUserInstance?.id)],-1)
printHtmlPart(21)
invokeTag('hiddenField','g',32,['name':("version"),'value':(traceUserInstance?.version)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1345214289966L
