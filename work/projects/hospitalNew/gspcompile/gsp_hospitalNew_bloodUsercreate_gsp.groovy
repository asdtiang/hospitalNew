...
class gsp_hospitalNew_bloodUsercreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bloodUser/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(bloodUserInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(bloodUserInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1345132618059L
