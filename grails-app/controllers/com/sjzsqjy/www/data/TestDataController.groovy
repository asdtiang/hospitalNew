...
class TestDataController {
    ...
    def list(Integer max) {
        ...
        [testDataInstanceList: TestData.list(params), testDataInstanceTotal: TestData.count()]
    }
    ...
    def showResult(Long id){
        ...
        def testType =  testDataInstance.type
        def result = freemarkerService.generateResult(testType.id+"",testDataInstance.jsonData.replaceAll("null",'"null"'))
        [testDataInstance: testDataInstance,result:result]
    }
}
