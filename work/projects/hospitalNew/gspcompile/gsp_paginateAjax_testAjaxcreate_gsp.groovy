...
class gsp_paginateAjax_testAjaxcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/paginate-ajax-0.1/grails-app/views/testAjax/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(12)
invokeTag('renderErrors','g',23,['bean':(testAjaxInstance),'as':("list")],-1)
printHtmlPart(13)
})
invokeTag('hasErrors','g',25,['bean':(testAjaxInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(14)
