...
class gsp_hospitalNew_sampleUseredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sampleUser/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'sampleUser.label', default: 'SampleUser'))],-1)
printHtmlPart(2)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',27,['bean':(sampleUserInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',29,['bean':(sampleUserInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',31,['name':("id"),'value':(sampleUserInstance?.id)],-1)
printHtmlPart(21)
invokeTag('hiddenField','g',32,['name':("version"),'value':(sampleUserInstance?.version)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1344777517934L
