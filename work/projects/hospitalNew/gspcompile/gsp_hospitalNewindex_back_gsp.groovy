...
class gsp_hospitalNewindex_back_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/index_back.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('include','g',12,['controller':("index"),'action':("hospitalDesc")],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1352121372539L
