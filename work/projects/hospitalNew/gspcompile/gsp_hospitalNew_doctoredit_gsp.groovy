...
class gsp_hospitalNew_doctoredit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(doctorInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',29,['bean':(doctorInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',31,['name':("id"),'value':(doctorInstance?.id)],-1)
printHtmlPart(21)
invokeTag('hiddenField','g',32,['name':("version"),'value':(doctorInstance?.version)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1344777530408L
