...
class gsp_hospitalNew_sampleUsercreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sampleUser/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(sampleUserInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(sampleUserInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1344777517941L
