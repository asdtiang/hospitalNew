...
class gsp_hospitalNew_linklist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/link/list.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('sortableColumn','g',27,['property':("showTitle"),'title':(message(code: 'link.showTitle.label', default: 'Show Title'))],-1)
printHtmlPart(11)
invokeTag('sortableColumn','g',28,['property':("address"),'title':(message(code: 'link.address.label', default: 'Address'))],-1)
printHtmlPart(12)
loop:{
int i = 0
...
invokeTag('link','g',38,['action':("show"),'id':(linkInstance.id)],3)
printHtmlPart(15)
...
printHtmlPart(18)
invokeTag('paginate','g',50,['total':(linkInstanceTotal)],-1)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1352121372726L
