...
class gsp_hospitalNew_registrationCodesearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/registrationCode/search.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(15)
createTagBody(4, {->
codecOut.print(fieldValue(bean: registrationCode, field: "token"))
})
invokeTag('link','g',58,['action':("edit"),'id':(registrationCode.id)],4)
printHtmlPart(16)
createTagBody(4, {->
codecOut.print(fieldValue(bean: registrationCode, field: "username"))
})
...
public static final long LAST_MODIFIED = 1340368264671L
