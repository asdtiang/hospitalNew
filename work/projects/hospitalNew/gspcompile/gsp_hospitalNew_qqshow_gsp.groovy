...
class gsp_hospitalNew_qqshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/qq/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('message','g',27,['code':("qq.id.label"),'default':("Id")],-1)
printHtmlPart(12)
codecOut.print(fieldValue(bean: qqInstance, field: "id"))
printHtmlPart(13)
invokeTag('message','g',34,['code':("qq.sequence.label"),'default':("Sequence")],-1)
printHtmlPart(12)
codecOut.print(fieldValue(bean: qqInstance, field: "sequence"))
printHtmlPart(13)
invokeTag('message','g',41,['code':("qq.code.label"),'default':("Code")],-1)
printHtmlPart(12)
codecOut.print(qqInstance?.code)
printHtmlPart(13)
invokeTag('message','g',48,['code':("qq.info.label"),'default':("Info")],-1)
printHtmlPart(12)
codecOut.print(fieldValue(bean: qqInstance, field: "info"))
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(15)
invokeTag('hiddenField','g',59,['name':("id"),'value':(qqInstance?.id)],-1)
printHtmlPart(16)
invokeTag('actionSubmit','g',60,['class':("edit"),'action':("edit"),'value':(message(code: 'default.button.edit.label', default: 'Edit'))],-1)
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1352121372813L
